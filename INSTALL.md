# Installation from Void Scanner GitHub

## Manual Installation (Recommended)

For users who want the latest version and aren't using F-Droid:
...
### Alternative:
If you don't see a release yet, you're welcome to check out the source code from GitHub and build it yourself using Android Studio.
